...
public class MySort {
   ...
   */
    ...
    //7：快速排序（递归方式）==========分组方式有---->7.1（Hoare霍尔排序） 7.2（挖坑法） 7.3（前后遍历法）7.4（三数取中法）
    //非递归方式======================================================================================================
    /*
        快排递归：
...
//测试1===========（输出排序后的数组）
    ...
    public static void test2(){
        ...
        System.out.printf("插入排序insertSort time\t:  %.4fms\n", (end - begin) * 1.0 / 1000 / 1000);

        begin = System.nanoTime();
        shellSort(arr2);
        end = System.nanoTime();
        System.out.printf("希尔排序shellSort time\t:  %.4fms\n", (end - begin) * 1.0 / 1000 / 1000);

        begin = System.nanoTime();
        selectSort(arr3);
        end = System.nanoTime();
        System.out.printf("选择排序selectSort time\t:  %.4fms\n", (end - begin) * 1.0 / 1000 / 1000);

        begin = System.nanoTime();
        heapSort(arr4);
        end = System.nanoTime();
        System.out.printf("堆排序heapSort time\t:  %.4fms\n", (end - begin) * 1.0 / 1000 / 1000);

        begin = System.nanoTime();
        bubbleSort(arr5);
        end = System.nanoTime();
        System.out.printf("冒泡排序bubbleSort time\t:  %.4fms\n", (end - begin) * 1.0 / 1000 / 1000);

        begin = System.nanoTime();
        quickSort(arr6, 0, arr6.length - 1);
        end = System.nanoTime();
        System.out.printf("快速排序-递归quickSort time\t:  %.4fms\n", (end - begin) * 1.0 / 1000 / 1000);

        begin = System.nanoTime();
        quickSortNoR(arr7);
        end = System.nanoTime();
        System.out.printf("快速排序-非递归quickSortNoR time\t:  %.4fms\n", (end - begin) * 1.0 / 1000 / 1000);

        begin = System.nanoTime();
        merge(arr8);
        end = System.nanoTime();
        System.out.printf("归并排序mergeSort time\t:  %.4fms\n", (end - begin) * 1.0 / 1000 / 1000);
